...
//       }}
//     >
//       <img className="profile" alt={user.name} src={user.thumb} style={{display:'none'}} />
...
const NavUserMenu = () => {
  ...
  return (
    <Dropdown as="div" bsPrefix="user-containersadsa d-flexjshadsah" onToggle={onToggle} show={showingNavMenu === MENU_NAME} drop="down">
